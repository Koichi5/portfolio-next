  ...
  return (
    ...
    >
      <div style={{ width: "60%", padding: "40px" }}>
        ...
        <WorksDetailText text={"I am a software engineering student from Japan, primarily focused on mobile app development. This portfolio compiles my experiences from internships and contests I have participated in."} />
      </div>
      <WorksCardGrid />
    </div>
  );
